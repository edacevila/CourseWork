...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.registration = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, role, finduser, hash, usercreate, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, email = _a.email, password = _a.password, role = _a.role;
                        if (!email || !password) {
                            return [2 /*return*/, res.status(400).json({ message: "He указан email или password" })];
                        }
                    ...
                    case 2:
                        hash = _b.sent();
                        return [4 /*yield*/, models_1.User.create({ email: email, role: role, password: hash })];
                    case 3:
                        usercreate = _b.sent();
                        return [4 /*yield*/, models_1.Basket.create({ userId: usercreate.dataValues.id })];
                    case 4:
                        _b.sent();
                        token = generateJwt(usercreate.dataValues.id, email, role);
    ...
    UserController.prototype.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, usercreate, comparePassword, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        comparePassword = bcrypt_1.default.compareSync(password, usercreate.dataValues.password);
                        if (!comparePassword) {
                            res.status(403).json({ message: "Указан неверный пароль" });
                        }
                        token = generateJwt(usercreate.dataValues.id, email, usercreate.dataValues.role);
    ...
    UserController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, name, number, updateUser;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = req.query.id;
                        _a = req.body, name = _a.name, number = _a.number;
                        return [4 /*yield*/, models_1.User.update({}, { where: { id: id } })];
                    case 1:
                        updateUser = _b.sent();
                        return [2 /*return*/];
                }
